...
async def help_message_f(client, message):
    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/pigasusupdates).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Developer', url='https://t.me/Rohith_no_1'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('bot', url='https://t.me/VALTAOITHEBOT') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
